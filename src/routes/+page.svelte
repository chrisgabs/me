    ...
    <header class="flex h-svh w-full items-center text-slate-900 md:sticky md:top-0 md:pt-24 md:pl-auto md:w-fit">
        <div class="flex flex-col justify-between min-h-content gap-20 md:pb-28 md:gap-0 md:h-full md:min-w-80">
            ...
            <div class="text-sm md:text-xs">
                <ul class="flex items-center mt-4 gap-4">
                    <li>
                        <a href="/resume_bayquen.pdf" target="_blank" rel="noopener noreferrer" class="flex items-center gap-1">
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/christian-bayquen/" target="_blank" class="flex items-center gap-1">
